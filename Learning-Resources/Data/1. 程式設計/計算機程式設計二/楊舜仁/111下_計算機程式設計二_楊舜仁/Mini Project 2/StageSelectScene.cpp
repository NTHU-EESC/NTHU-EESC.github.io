...
void StageSelectScene::Initialize() {
    ...
    AddNewObject(new Engine::Label("Stage 1", "pirulen.ttf", 48, halfW, halfH - 200, 0, 0, 0, 255, 0.5, 0.5));
    // Stage 2 button
    ...
    btn->SetOnClickCallback(std::bind(&StageSelectScene::SettingsOnClick, this));
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("Settings", "pirulen.ttf", 48, halfW, halfH + 200, 0, 0, 0, 255, 0.5, 0.5));
...
void StageSelectScene::SettingsOnClick() {
    // PlayScene* scene = dynamic_cast<PlayScene*>(Engine::GameEngine::GetInstance().GetScene("settings"));
    // scene->MapId = stage;
